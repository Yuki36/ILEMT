function [resultArray, data] = ExtractData(fileDirectory)    
    ...
    metalMap = containers.Map({1, 2, 3, 4, 5, 6}, {'LC Steel', '416 SS', '304 SS', '6061 Al', 'Ti Grade 5', 'Copper'});
    ...
    % Add column names to the table
    VM.Properties.VariableNames = {'MetalShape', 'MetalNumber', 'Validity Check Value of Translation Error', 'Validity Check Value of Rotation Error'};
    % Display VM table
    disp(VM);
    ...
    %% Summary
    validityCheckTable = table(data{:, 2}, data{:,3}, transVMResult, rotVMResult, 'VariableNames', {'Metal Shape', 'Metal Name', 'Validity Check Translation Error Value', 'Validity Check Rotation Error Value'});
